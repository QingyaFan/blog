...
2. [调度：koordinator 如何支持混布](https://github.com/QingyaFan/blog/issues/72)
3. [Batch Schedule 和 Volcano 的实现](https://github.com/QingyaFan/blog/issues/65)
4. [Kubernetes编排原理和定制（CRD）](https://github.com/QingyaFan/blog/issues/41)
5. [CRD Controller多副本选主](https://github.com/QingyaFan/blog/issues/55)
6. [CRD Controller 事件机制的设计](https://github.com/QingyaFan/blog/issues/58)
7. [在Kubernetes中使用GPU](https://github.com/QingyaFan/blog/issues/53)
8. [Kubernetes的核心编排调度能力们](https://github.com/QingyaFan/blog/issues/52)
9. [Configmap热更新原理](https://github.com/QingyaFan/blog/issues/2)
10. [Pod生命周期状态](https://github.com/QingyaFan/blog/issues/31)
11. [OpenKruise的CloneSet如何利用Pod状态实现原地变更](https://github.com/QingyaFan/blog/issues/42)
12. [Kubernetes的组件以及交互过程](https://github.com/QingyaFan/blog/issues/46)
13. [Docker的隔离原理](https://github.com/QingyaFan/blog/issues/47)
...
4. [如何训练一个模型](https://github.com/QingyaFan/blog/issues/40)
5. [如何微调一个模型（fine-tune）](https://github.com/QingyaFan/blog/issues/45)
6. [如何使用开源的模型，如llama3、phi-3](https://github.com/QingyaFan/blog/issues/43)
